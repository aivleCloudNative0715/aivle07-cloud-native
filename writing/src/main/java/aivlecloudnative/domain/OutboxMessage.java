// src/main/java/aivlecloudnative/domain/OutboxMessage.java (제공해주신 파일 그대로)
...
public class OutboxMessage {
    ...
    private String eventId; // UUID 등으로 생성 권장
    ...
    // 발행 시도 시간
    private LocalDateTime publishedAt; // Kafka 발행 성공 시 업데이트
